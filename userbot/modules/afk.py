...
async def mention_afk(mention):
    """ Bu funksiya kimsə sizi etiketlədikdə AFK olduğunuzu bilmək imkanı verir.."""
    global COUNT_MSG
    global USERS
    global ISAFK
    try:
...
async def afk_on_pm(sender):
    """ Afk olduğunuz zaman sizə PM göndərənləri xəbərdar etmək funksiyasıdır. """
    global ISAFK
    global USERS
    global COUNT_MSG
...
async def set_afk(afk_e):
    """ .afk əmri insanlara afk olduğunuz halda afk olduğunuzu bildirir.. """
    message = afk_e.text
...
async def type_afk_is_not_true(notafk):
    """ Bu bölmə hardasa nəsə yazdığınız zaman sizi AFK rejimindən çıxaracaq. """
    global ISAFK
    global COUNT_MSG
    global USERS
    global AFKREASON
...
CmdHelp('afk').add_command(
    'afk',
    '<İstəyə bağlı səbəb>',
    'AFK olduğunuzu göstərir. Kim sizə pm göndərsə və ya sizi tag etsə, AFK olduğunuzu və təyin etdiyiniz səbəbi göstərəcək. İstənilən yerə mesaj yazdığınız zaman AFK rejimi sönür.'
).add()
